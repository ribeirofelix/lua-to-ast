...
#define UPVALUE(r) (char*)getstr(F->f->upvalues[r].name)
...
char* ProcessCode(const Proto * f, int indent)
{
   ...
   for (pc = 0; pc < n; pc++) {
      ...
      case OP_GETTABUP:
         {
            // TODO: ISSO ERA GETGLOBAL... nao sei oq vai dar
            /*
      ...
      case OP_SETTABUP:
         {
            // TODO : Isso era SETGLOBAL... nao sei q bixo vai dar
            /*
